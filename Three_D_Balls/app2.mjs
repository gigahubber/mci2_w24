...
window.onload = async function () {
    ...
    camera.position.set(0, 0.3, 2); // x,y,z

    const scene = new THREE.Scene(); // Erstellen einer neuen Szene
    const world = new THREE.Group(); // Erstellen einer neuen Gruppe
    ...
    const dirLight = new THREE.DirectionalLight(0xffffff, 3); // Farbe, Intensität des lichts
    ...
    const width = 0.1;
    const box = new THREE.BoxGeometry(10, width, 10, 10, 1, 10); // Breite, Höhe, Tiefe, Breite Segmente, Höhe Segmente, Tiefe Segmente
